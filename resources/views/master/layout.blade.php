      ...
      <nav id="navbar" class="navbar">
        <ul>
          <li><a class="nav-link scrollto active" href="#hero">Homes</a></li>
              ...
              <li class="dropdown"><a href="#"><span>Check</span> <i class="bi bi-chevron-right"></i></a>
                <ul>
                <li><a class="nav-link scrollto" href="/check-reg">Registration in an Event</a></li>
                <li><a class="nav-link scrollto" href="/check-reg-student">Student is registered event</a></li>
                <li><a class="nav-link scrollto" href="/add-student">Add New Student</a></li>
                <li><a class="nav-link scrollto" href="/retrieve">Retrieve Student Details</a></li>
                </ul>
              </li>
            </ul>
          </li>
